...
if(!defined('MagicZoomModuleCoreClassLoaded')) {
    ...
    class MagicZoomModuleCoreClass {
        ...
        function headers($jsPath = '', $cssPath = null, $notCheck = false) {
            ...
            $headers = array();
            $headers[] = '<!-- Magic Zoom OpenCart module version v2.8.62 [v1.2.37:v4.0.25] -->';
