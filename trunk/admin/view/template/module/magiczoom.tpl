  ...
  <div class="content">
    ...
    <h3 class="settingsTitle">Module status</h3>
        ...
        <table class="params" cellspacing="0">
            <tr class="last">
                <th width="30%">
                    <label for="magiczoomsettingStatus">Enable/Disable module</label>
                </th>
                <td width="70%">
                    <select name="magiczoom_status">
                    <?php if ($magiczoom_status) { ?>
    ...
    <?php
                            ...
                            switch($s["type"]) {
                                case "array":
                                        ...
                                        foreach($s["values"] as $p) {
                                            ...
                                            $rButtons[strtolower($p)] = '<label><input type="radio" value="'.$p.'"'. ($s["value"]==$p?"checked=\"checked\"":"").' name="'.$s['id'].'" id="magiczoomsettings'. ucwords(strtolower($name)).$p.'">';
                                            $pName = ucwords($p);
                                            if(strtolower($p) == "yes")
                                ...
                                default:
                                    ...
                                    if (!isset($s["value"])) $s["value"] = $s["default"];
                                    $html .= '<input '.$width.' type="text" name="'.$s['id'].'" id="magiczoomsettings'. ucwords(strtolower($name)).'" value="'.$s["value"].'" />';
                                    break;
                            }
        ...
        <table class="params" cellspacing="0">
            <tr>
                <th width="30%">
                    <label for="magiczoomsettingChache-path">Path to cache folder<br/>Relative for site base path</label>
                </th>
                <td width="70%">
            ...
            <tr class="back">
                <th width="30%">
                    <label for="magiczoomsettingTotal-items">Total items</label>
                </th>
                <td width="70%">
        ...
        <tr>
            <th width="30%">
                <label for="magiczoomsettingUnuser-items">Unused items</label>
            </th>
            <td width="70%">
        ...
        <tr class="last back">
            <th width="30%"><label for="magiczoomsettingEmpte-chache">Empty cache</label></th>
            <td width="70%">
